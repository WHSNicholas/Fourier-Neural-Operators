...
#                                       1D Inviscid Burgers Equation - Data Merge                                      #
# -------------------------------------------------------------------------------------------------------------------- #
...
# %% 2. Merging Data -----------------------------------------------------------------------------------------
# Sample Files
file_paths = sorted(glob.glob("inviscid_burgers_batch_*.npz"))
...
with h5py.File("burgers_inviscid_dataset.h5", "w") as f:
    # Inputs
...
print(f"✅ Merged {len(file_paths)} files into burgers_inviscid_dataset.h5")
